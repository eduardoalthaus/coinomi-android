...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='MarteX.conf'
CONFIGFOLDER='/root/.MXT'
COIN_DAEMON='martexd'
COIN_CLI='martex-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/martexcoin/martexcoin/releases/download/v3.0.0-fix/martexcore-3.0.0-x86_64-linux-gnu.tar.gz'
